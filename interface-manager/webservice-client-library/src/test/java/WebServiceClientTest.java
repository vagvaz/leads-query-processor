import eu.leads.processor.core.plan.Query;
...
public class WebServiceClientTest {
   ...
   public static void main(String[] args) throws IOException {
      ...
      QueryStatus status = WebServiceClient.submitQuery("vagvaz","SELECT url,domainName from webpages where sentiment=0.8 group by group order by url limit 5");
