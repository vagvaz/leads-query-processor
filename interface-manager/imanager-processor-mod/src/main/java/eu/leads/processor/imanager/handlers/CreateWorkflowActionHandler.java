...
import eu.leads.processor.core.plan.WorkflowQuery;
 ...
 */
public class CreateWorkflowActionHandler implements ActionHandler {
    ...
    public CreateWorkflowActionHandler(Node com, LogProxy log, InfinispanManager persistence,
                                       String id) {
        this.com = com;
        this.log = log;
    ...
    public Action process(Action action) {
        ...
        try {
            ...
            if (q.containsField("workflow")) {//Workflow Query
                String user = q.getString("user");
                String workflow = q.getString("workflow");
                String uniqueId = generateNewQueryId(user);

                WorkflowQuery query = new WorkflowQuery(user, workflow);
