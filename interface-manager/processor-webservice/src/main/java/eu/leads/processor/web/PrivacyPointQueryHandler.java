 ...
 */
public class PrivacyPointQueryHandler implements Handler<HttpServerRequest> {
   Node com;
   Logger log;
   ...
   public PrivacyPointQueryHandler(final Node com, Logger log) {
      this.com = com;
      this.log = log;
   ...
   private class SubmitSpecialCallBodyHandler implements Handler<Buffer> {
      ...
      public void handle(Buffer body) {
         ...
         action.setLabel(IManagerConstants.SUBMIT_ENC_QUERY);
