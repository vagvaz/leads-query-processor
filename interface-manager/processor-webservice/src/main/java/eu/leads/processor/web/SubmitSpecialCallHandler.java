...
public class SubmitSpecialCallHandler implements Handler<HttpServerRequest> {
   ...
   private class SubmitSpecialCallBodyHandler implements Handler<Buffer> {
      ...
      public SubmitSpecialCallBodyHandler(String requestId, SubmitSpecialCallReplyHandler replyHandler) {
   ...
   public void handle(HttpServerRequest request) {
      ...
      SubmitSpecialCallReplyHandler replyHandler = new SubmitSpecialCallReplyHandler(reqId, request);
