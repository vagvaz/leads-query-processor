...
import org.apache.tajo.engine.planner.graph.DirectedGraph;
...
public class LogicalPlanVisitorTest {
   ...
   public static void main(String[] args) throws Exception {
      ...
      String line = "select dept.deptname,dept.tmsp from dept join ( select score,phone,deptname,sumtest(score) as tmsp from score group by score,phone, deptname) s on dept.deptname = s.deptname and s.tmsp = dept.tmsp";
...
//      System.out.println("explan " + explan);
   ...
   public static void TestsetUp() throws Exception {
      ...
      TableDesc score3 = new org.apache.tajo.catalog.TableDesc(
                                                                      ...
                                                                      schema5, CatalogProtos.StoreType.MEM, new KeyValueSet(), new Path("score3"));
      catalog.createTable(score3);

      FunctionDesc funcDesc = new FunctionDesc("sumtest", SumInt.class, CatalogProtos.FunctionType.AGGREGATION,
