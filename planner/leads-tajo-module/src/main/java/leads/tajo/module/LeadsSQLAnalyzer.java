...
public class LeadsSQLAnalyzer extends LeadsSQLParserBaseVisitor<Expr> {
  ...
  public Expr visitSession_statement(@NotNull LeadsSQLParser.Session_statementContext ctx) {
  ...
  @Override public WindowFunctionExpr visitWindow_function(@NotNull LeadsSQLParser.Window_functionContext context) {
  ...
  @Override
  public LiteralValue visitUnsigned_numeric_literal(@NotNull LeadsSQLParser.Unsigned_numeric_literalContext ctx) {
    if (ctx.NUMBER() != null) {
...
//    }
  ...
  @Override
  public Expr visitDrop_database_statement(@NotNull LeadsSQLParser.Drop_database_statementContext ctx) {
  ...
  @Override
  public Expr visitTruncate_table_statement(@NotNull LeadsSQLParser.Truncate_table_statementContext ctx) {
  ...
  @Override
  public Expr visitUnsigned_value_specification(@NotNull LeadsSQLParser.Unsigned_value_specificationContext ctx) {
    return visitChildren(ctx);
  }
  ...
  @Override
  public Expr visitDatetime_value_expression(@NotNull LeadsSQLParser.Datetime_value_expressionContext ctx) {
  ...
  @Override
  public Expr visitDatetime_value_function(@NotNull LeadsSQLParser.Datetime_value_functionContext ctx) {
  ...
  @Override
  public Expr visitCurrent_date_value_function(@NotNull LeadsSQLParser.Current_date_value_functionContext ctx) {
  ...
  @Override
  public Expr visitCurrent_time_value_function(@NotNull LeadsSQLParser.Current_time_value_functionContext ctx) {
  ...
  @Override
  public Expr visitCurrent_timestamp_value_function(@NotNull LeadsSQLParser.Current_timestamp_value_functionContext ctx) {
  ...
  @Override
  public Expr visitAlter_tablespace_statement(@NotNull LeadsSQLParser.Alter_tablespace_statementContext ctx) {
