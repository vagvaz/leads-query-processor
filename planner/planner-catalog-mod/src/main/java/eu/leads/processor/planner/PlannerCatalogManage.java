 ...
 */
public class PlannerCatalogManage extends ManageVerticle {
   protected final String serviceType = "planner-catalog";
   ...
   public void startService() {
      ...
      if(workerId == null) {
         workerId = "";
         container.deployWorkerVerticle(PlannerCatalogWorker.class.getCanonicalName(), workerConfig, 1, false, new Handler<AsyncResult<String>>() {
            @Override
            public void handle(AsyncResult<String> event) {
               if (event.succeeded()) {
                  workerId = event.result();
                  logProxy.info("PlannerCatalogWorker has been deployed.");
                  ...
                  String msg = "PlannerCatalogWorker could not be deployed";
