...
public class TestClassForName {
  ...
  public static void main(String[] args) {
    ...
    String filePath = "/home/vagvaz/Projects/idea/transform-plugin/target/transform-plugin-1.0-SNAPSHOT-jar-with-dependencies.jar";
    ...
    String path = "/tmp/leads/processor/tmp/pluginstmp/plugins/eu.leads.processor.plugins.transform.TransformPlugin.jar";
