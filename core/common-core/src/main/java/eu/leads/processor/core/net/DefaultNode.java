...
public class DefaultNode implements Node {
   ...
   public void sendTo(String nodeid, JsonObject message) {
      JsonObject leadsMessage = MessageUtils.createLeadsMessage(message, getId(), nodeid, ComUtils.P2P);
   ...
   public void sendToAllGroup(String groupId, JsonObject message) {
      JsonObject leadsMessage = MessageUtils.createLeadsMessage(message, getId(), groupId, ComUtils.ALLGROUP);
