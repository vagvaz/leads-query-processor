...
public class PersistenceManageVerticle extends ManageVerticle {
    ...
    public void startService() {
        ...
        if (persistVertcileId == null) {
            ...
            getContainer().deployWorkerVerticle("eu.leads.processor.core.PersistenceVerticle",
                                                   getContainer().config(), 1, false,
                                                   new Handler<AsyncResult<String>>() {
                                                       ...
                                                       public void handle(AsyncResult<String> asyncResult) {
                                                           if (asyncResult.succeeded()) {
                                                               getContainer().logger()
                                                                   .info("Persist Vertice has been deployed ID "
                                                                             + asyncResult
                                                                                   .result());
                                                               persistVertcileId =
                                                                   asyncResult.result();
                                                               ...
                                                               getContainer().logger()
                                                                   .fatal("Persist Verticle failed to deploy");
    ...
    public void stopService() {
        ...
        container.undeployVerticle(persistVertcileId, new Handler<AsyncResult<Void>>() {
            ...
            public void handle(AsyncResult<Void> asyncResult) {
                if (asyncResult.succeeded()) {
                    container.logger()
                        .info("Persist Vertice has been deployed ID " + asyncResult.result());
