...
public class CrawlerConfiguration {
   ...
   /**
    * Constructs a new CrawlerConfiguration.
    */
   ...
   /**
    * Sets maximum http errors for a single domain. If this limit is exceeded - domain will not be
    * crawled any more.
    *
    * @param maxHttpErrors
    */
   ...
   /**
    * Returns domain constraints for {@code domainName}. If specific constraints for this domain are
    * not set - returns {@code null}.
    *
    * @param domainName
    *
    * @return
