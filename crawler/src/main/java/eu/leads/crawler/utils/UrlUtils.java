...
public class UrlUtils {
   ...
   /**
    * Gets parameter value from the url. If tryRewrited is true - tries to parse rewrited url using
    * getRewritedParameter method
    *
    * @param url
    * @param parameterName
    * @param tryRewrited
   ...
   /**
    * Downloads content from the specified url using specified proxy (or do not using it). Returns
   ...
   /**
    * Downloads content from the specified url using specified proxy (or do not using it) and
    * timeouts. Returns null if there's an error.
    *
    * @param url
    * @param proxy
    * @param readTimeout
