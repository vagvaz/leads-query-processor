...
/**
 * Default {@link eu.leads.crawler.parse.ParserController} implementation. You can set one generic parser and some custom parsers
 * for specified domains. Generic parser will be used for {@link eu.leads.crawler.model.Page} if there's no compatible custom parser.
 *
 * @author ameshkov
 */
