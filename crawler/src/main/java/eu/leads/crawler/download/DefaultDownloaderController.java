...
/**
 * Default controller implementation. Provides generic downloader for all urls or custom downloader
 * for specific domain.
 *
 * @author ameshkov
 */
public class DefaultDownloaderController implements DownloaderController {
   ...
   /**
    * Creates an instance of the {@code DefaultDownloaderController} class. {@link DefaultDownloader}
    * is used as generic downloader.
    */
    ...
    *
    * @param genericDownloader
    * @param customDownloaders Custom downloaders map. Key is domain name, value is custom downloader
    *                          for this domain.
    */
