...
/**
 * Default implementation of the proxy controller. Starts special monitoring thread used to check if
 * proxies are alive. Balances proxies, returning next proxy from the list after each request
 *
 * @author ameshkov
 */
