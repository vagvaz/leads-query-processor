...
import eu.leads.processor.infinispan.operators.CreateIndexOperator;
 ...
 */
public class CreateIndexOperatorTest {
  ...
  public static void main(String[] args) {
    ...
    String configString = "{\n" +
            ...
            "        \"body\" : {\n" +
            "          \"tableDesc\" : {\n" +
            "            \"tableName\" : \"crawler.default.cache\",\n" +
            "            \"schema\" : {\n" +
            "              \"fields\" : [  {\n" +
            "                \"name\" : \"url\",\n" +
            "                \"dataType\" : {\n" +
            ...
            "              }\n" +
            "            },\n" +
            "            \"uri\" : \"file:/home/vagvaz/Projects/idea/leads-query-processor/target/test-data/student\",\n" +
            "            \"external\" : true\n" +
            "          },\n" +
            "          \"logicalSchema\" : {\n" +
            "            \"fields\" : [  {\n" +
    ...
    String query = "{\n" +
            ...
            "  ],\n" +
            "  \"IndexMethodSpec\": {\n" +
            "    \"IndexMethodName\": \"TWO_LEVEL_BIN_TREE\"\n" +
            "  },\n" +
            "  \"Expr\": {\n" +
            "    \"IsDistinct\": false,\n" +
            "    \"Projections\": [\n" +
            ...
            "  \"OpType\": \"CreateIndex\"\n" +
            "}";
          confg.getObject("configuration").putString("query", query);
   // confg.
    ...
    Op.putObject("operator", new JsonObject(query));


    action.setData(Op);
    Node com = new DefaultNode();
    LogProxy log = new LogProxy("log", com);

    CreateIndexOperator operator = new CreateIndexOperator(com, InfinispanClusterSingleton.getInstance().getManager(), log, action);
    operator.init(action.getData().getObject("operator"));
    operator.execute();
    try {
      operator.join();
    ...
    //PrintUtilities.saveMapToFile(ouptut,"/home/vagvaz/test/scanOutput.json");
