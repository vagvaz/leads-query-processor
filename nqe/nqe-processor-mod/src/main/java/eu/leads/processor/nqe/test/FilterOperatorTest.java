...
import eu.leads.processor.nqe.operators.FilterOperator;
import eu.leads.processor.nqe.operators.GroupByOperator;
import eu.leads.processor.nqe.operators.ProjectOperator;
...
public class FilterOperatorTest {
   public static void main(String[] args) {
      ...
      PrintUtilities.saveMapToFile(ouptut,"/home/vagvaz/test/filterOutput.json");
      manager.stopManager();
      System.exit(0);
