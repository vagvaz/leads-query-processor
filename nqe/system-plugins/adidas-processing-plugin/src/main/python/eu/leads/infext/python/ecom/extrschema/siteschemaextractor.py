...
#         self.__draw_baseurl_sampleset()
    ...
    def find_schema_opt(self):
        page_dict_list = self.__page_dict_list
        dataset_pages_number = len(page_dict_list)
        contents_list, buttonnode_list, basketnode_list, namenode_list = self.__get_pages_metadata()
    ...
    def find_schema(self):        
        ...
        # classify name node and fix basket node
        namenode_list, basketnode_list = self.__fix_namenode_basketnode_lists(basketnode_list, page_dict_list, contents_list)
