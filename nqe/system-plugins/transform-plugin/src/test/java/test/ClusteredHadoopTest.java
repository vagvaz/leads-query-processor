...
public class ClusteredHadoopTest {
    ...
    public static void main(String[] args) {
        Class pluginClass = TransformPlugin.class;
        ...
        PluginPackage plugin = new PluginPackage(pluginClass.getCanonicalName(),
              ...
              , "/home/trs/Projects/LEADS/leads-query-processor/nqe/system-plugins/sentiment-plugin/sentiment-conf.xml"); //"/home/vagvaz/Projects/idea/transform-plugin/transform-plugin-conf.xml" );
