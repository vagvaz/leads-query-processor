...
public class ClientSide {
    ...
    public CStore DB_preprossesing(String fileName, int NumberOfTuples)
        ...
        try {
            ...
            while ((line = bufferedReader.readLine()) != null) {
                ...
                aesCipherForEncryption
                    .init(Cipher.ENCRYPT_MODE, secretKey_tuple, new IvParameterSpec(iv));
    ...
    public HashMap<Integer, Record[]> TSetSetup(CStore cs)
            ...
            while (iter.hasNext()) {
                ...
                for (j = 0; j < arrayList.size(); j++) {
                    ...
                    RandomEngine generator =
                        new cern.jet.random.engine.MersenneTwister64(java.nio.ByteBuffer.wrap(Arrays
                                                                                                  .copyOfRange(PRFBytes,
                                                                                                                  0,
                                                                                                                  32))
                                                                         .getInt());
    ...
    public HashMap<String, ArrayList<String>> Decrypt_Answer(HashMap<String, Etuple> EDB,
                                                                HashMap<String, ArrayList<String>> encResult) {
        ...
        try {
            ...
            for (int i = 0; i < result.size(); i++) {
                aesCipherForDecryption.init(Cipher.DECRYPT_MODE, secretKey_tuple,
                                               new IvParameterSpec(EDB.get(result.get(i)).getIV()));
                byte[] byteDecryptedText;
                byteDecryptedText =
                    aesCipherForDecryption.doFinal(EDB.get(result.get(i)).getCiphertext());
