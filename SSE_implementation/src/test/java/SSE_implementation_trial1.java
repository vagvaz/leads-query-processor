...
public class SSE_implementation_trial1 {
    ...
    public static CStore encrypted_upload(int Svalue, double k, String sk_fileName, String inputFileName)
        throws Exception {
    ...
    public static CStore encrypted_upload(int Svalue, double k, String sk_fileName, Connection conn, String tableName,
