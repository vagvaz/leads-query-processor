...
public class TupleBuffer {
  ...
  private transient EnsembleCacheUtilsSingle keyValueDataTransfer;
  ...
  public TupleBuffer(int threshold, String cacheName, EnsembleCacheManager ensembleCacheManager, String mc,
      EnsembleCacheUtilsSingle keyValueDataTransfer) {
    this.keyValueDataTransfer = keyValueDataTransfer;
    //    ensembleCacheUtilsSingle = new EnsembleCacheUtilsSingle();
    this.threshold = threshold;
    buffer = new HashMap<>();
  ...
  public TupleBuffer(int localBatchSize, Cache localCache, EnsembleCacheUtilsSingle keyValueDataTransfer) {
