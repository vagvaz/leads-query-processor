...
public class ReplayTool {
    ...
    public ReplayTool(String baseDir, String webpagePrefixes, String nutchDataPrefixes, String ensembleString,
        ...
        emanager.start();
        nutchCache =
            emanager.getCache("WebPage", new ArrayList<>(emanager.sites()), EnsembleCacheManager.Consistency.DIST);
        if (multicloud)
    ...
    public void replayNutch(boolean load) {
        ...
        while (true) {
            ...
            System.out.println(
                "Finally loaded: " + counter + " tuples, no content count: " + nocontent_counter + " unique "
                    + uniqueKeys.size());
            break;
        }
    }
