...
public class Replay {
    ...
    public static void main(String[] args) {
        if (args.length < 4) {
            System.err.println(
                "Help, Replay args: ip:port path_of_data_keys prefixes webpagePrefixes delayms_per_put_tocache (multi)  \n(prefixes seperated with |)");
            System.out.println(
                "Example java -jar data-replay-1.0-SNAPSHOT-jar-with-dependencies.jar 10.106.0.33:11222,10.106.0.33:11223 /home/ubuntu/snapshot6268/ test-nutchWebBackup default.webpages 36000");
            System.exit(0);
        }
        int delay = 1000;
        if (args.length >= 5)
