...
public class VSnapshot {
    ...
    private static void loadFrom(String cacheName, String dir) throws IOException {
        ...
        LQPConfiguration.initialize();
        InfinispanManager manager = InfinispanClusterSingleton.getInstance().getManager();
        Cache acache = (Cache) manager.getPersisentCache(cacheName);
        VersionedCache cache = new VersionedCacheTreeMapImpl(acache,new VersionScalarGenerator(),acache.getName());
