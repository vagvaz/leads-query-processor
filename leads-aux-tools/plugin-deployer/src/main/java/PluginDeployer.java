...
public class PluginDeployer {
    public static void main(String[] args) {
        ...
        String webserviceHost =
            LQPConfiguration.getInstance().getConfiguration().getString("qe.webservice.host", "http://127.0.0.1");
        ...
        try {
            ...
            if (undeploy) {
                System.out.println(
                    "plugin.undeploy exists so undeploying " + pluginId + " from " + cache + " for " + "user ");
