...
public class PeriodicCheckHandler implements Handler<Long> {
   ...
   Node com;
   String deployerId;
   public PeriodicCheckHandler(String ownerId,String deployerId,String nqeGroup, LogProxy log, Node com,
                               Map<String,Integer> actionToLevelMap, Map<Integer,Map<String,Action>> monitoredActions){
