...
public interface PluginInterface {
    ...
    /**This function is called when a plugin is undeployed in order to cleanup (close connections etc)*/
    public void cleanup();

    /**Function called when a modification on a  key in a cache is performed
     * The function is called after the action
    ...
    /**Function called when a new  key in a cache is created
     * The function is called after the action
    ...
    /**Function called when a new  key in a cache is removed
     * The function is called after the action
