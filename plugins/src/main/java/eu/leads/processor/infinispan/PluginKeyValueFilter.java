...
public class PluginKeyValueFilter implements KeyValueFilter {
   ...
   private void initializePlugin(Cache cache, String plugName) {
      ...
      ConfigurationUtilities.addToClassPath(System.getProperty("java.io.tmpdir") + "/leads/plugins/" + plugName + ".jar");
      ...
      try {
         pluginConfig = new XMLConfiguration(System.getProperty("java.io.tmpdir") + "/leads/tmp/" + plugName + "-conf.xml");
