...
public class ValidateNodeFactory extends NodeFactory {

	public ValidateNodeFactory() {
		super();
	}
	...
	public ImageIcon getIcon() {
		return ValidateUtils.SMALL_VALIDATE_ICON;
	}
	...
	public String getNodeClass() {
		return ValidateNode.class.getName();
	}
