...
public class TextFunction extends AbstractConstantApatarFunction {
	...
	static ConstantFunctionInfo fi = new ConstantFunctionInfo("Text Constant", 0, 1, ERecordType.Text);
	static
	{
