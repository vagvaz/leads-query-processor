...
public class ToInt64TransformFunction extends AbstractApatarFunction {
	...
	public Object execute(List list) {
		...
		if (value instanceof Number) {
			retValue = ((Number) value).longValue();
		} else {
			retValue = value;
		}
	...
	static FunctionInfo	fi	= new FunctionInfo("To Int64", 1, 1);
	static {
