...
public class BooleanFunction extends AbstractConstantApatarFunction {
	boolean value;
	...
	static ConstantFunctionInfo fi = new ConstantFunctionInfo("Boolean Constant", 0, 1, ERecordType.Boolean);
	static
	{
	...
	public ImageIcon getIcon() {
		return UiUtils.BOOLEAN_COLUMN_NODE_ICON;
	}
	
	public void initFromElement(Element e) {
		super.initFromElement(e);
		value = Boolean.parseBoolean(e.getAttributeValue("value"));
	}
