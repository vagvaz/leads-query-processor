...
public class VersionToFunction extends AbstractConstantApatarFunction {
	long value;
	...
	static ConstantFunctionInfo fi = new ConstantFunctionInfo("To Timestamp", 0, 1, ERecordType.Numeric);
	static
	{
