...
public class ToSingleTransformFunction extends AbstractApatarFunction {
	...
	public Object execute(List list) {
		...
		if (value instanceof Number) {
			retValue = ((Number) value).byteValue();
		} else {
			retValue = value;
		}
	...
	static FunctionInfo	fi	= new FunctionInfo("To Single", 1, 1);
	static {
