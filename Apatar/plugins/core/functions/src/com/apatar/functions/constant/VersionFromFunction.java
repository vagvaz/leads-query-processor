...
public class VersionFromFunction extends AbstractConstantApatarFunction {
	long value;
	...
	static ConstantFunctionInfo fi = new ConstantFunctionInfo("From Timestamp", 0, 1, ERecordType.Numeric);
	static
	{
		//fi.getCategories().add(FunctionCategory.Constant);@@
		fi.getCategories().add(FunctionCategory.Version);
	}
