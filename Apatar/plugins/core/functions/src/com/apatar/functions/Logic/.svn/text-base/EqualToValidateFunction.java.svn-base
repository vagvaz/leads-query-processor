...
public class EqualToValidateFunction extends AbstractApatarFunction {
	public Object execute(List list) {
		...
		try {
			return CompareUtils.Compare(list.get(0), list.get(1)) == 0;
	...
	static FunctionInfo fi = new FunctionInfo("Equal To", 2, 1);
	static {
