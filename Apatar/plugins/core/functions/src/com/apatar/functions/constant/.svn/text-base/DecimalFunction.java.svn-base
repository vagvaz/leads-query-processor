...
public class DecimalFunction extends AbstractConstantApatarFunction {
	double value;
	...
	static ConstantFunctionInfo fi = new ConstantFunctionInfo("Decimal Constant", 0, 1, ERecordType.Decimal);
	static
	{
	...
	public ImageIcon getIcon() {
		return UiUtils.DECIMAL_COLUMN_NODE_ICON;
	}
