...
public class ToInt16TransformFunction extends AbstractApatarFunction {
	public Object execute(List list) {
		Object retValue;
		Object value = list.get(0);

		if (value instanceof Number) {
			retValue = ((Number) value).shortValue();
		} else if (value instanceof Boolean) {
			retValue = ((Boolean) value == true ? 1 : 0);
	...
	static FunctionInfo	fi	= new FunctionInfo("To Int16", 1, 1);
	static {
