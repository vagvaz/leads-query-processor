...
public class Sliding_windowFunction extends AbstractConstantApatarFunction {
	long value;
	...
	static ConstantFunctionInfo fi = new ConstantFunctionInfo("Range_T Value", 0, 1, ERecordType.Numeric);
	static
	{
		//fi.getCategories().add(FunctionCategory.Constant);@@
		fi.getCategories().add(FunctionCategory.Sliding_window);
	}
