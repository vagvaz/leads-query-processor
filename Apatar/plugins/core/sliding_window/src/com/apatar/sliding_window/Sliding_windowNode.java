...
public class Sliding_windowNode extends ValidateNode {

	public Sliding_windowNode () {
		super();
		title = "Sliding_window";
		outputConnectionList.remove(getConnPoint(ValidateNode.OUTPUT_CONN_POINT_FALSE));
	}
	...
	public boolean realEdit(AbstractApatarActions actions) {
		return JSubProjectDialog.showDialog(ApatarUiMain.MAIN_FRAME,
				"Sliding window", this, new String[] { INPUT_CONN_POINT },
				FunctionsPlugin.getNodesFunctionSliding_window(), false,
