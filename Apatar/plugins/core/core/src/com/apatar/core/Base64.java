...
public class Base64 {
	...
	public static class InputStream extends java.io.FilterInputStream {
		...
		private int				position;		// Current position in the
												// buffer
		private final byte[]	buffer;		// Small buffer holding converted
											// data
		private final int		bufferLength;	// Length of buffer (3 or 4)
		private int				numSigBytes;	// Number of meaningful bytes in
												// the buffer
		private int				lineLength;
		private final boolean	breakLines;	// Break lines at less than 80
											// characters
		private final int		options;		// Record options used to create
												// the stream.
		private final byte[]	alphabet;		// Local copies to avoid extra
												// method calls
		private final byte[]	decodabet;		// Local copies to avoid extra
												// method calls
	...
	public static class OutputStream extends java.io.FilterOutputStream {
		...
		private final byte[]	alphabet;			// Local copies to avoid
													// extra method calls
		private final byte[]	decodabet;			// Local copies to avoid
													// extra method calls
