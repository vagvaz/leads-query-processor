...
public class JDirectoryChooserBeanInfo extends SimpleBeanInfo
{
   ...
   public BeanInfo[] getAdditionalBeanInfo()
   {
      ...
      try
      {
         for (Class cl = com.l2fprod.common.swing.JDirectoryChooser.class.getSuperclass(); !cl.equals(javax.swing.JFileChooser.class.getSuperclass()); cl = cl.getSuperclass()) {
