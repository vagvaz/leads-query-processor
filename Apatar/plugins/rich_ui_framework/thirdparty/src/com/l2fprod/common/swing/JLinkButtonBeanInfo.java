...
public class JLinkButtonBeanInfo extends SimpleBeanInfo
{
   ...
   public BeanInfo[] getAdditionalBeanInfo()
   {
      ...
      try
      {
         for (Class cl = com.l2fprod.common.swing.JLinkButton.class.getSuperclass(); !cl.equals(java.awt.Component.class.getSuperclass()); cl = cl.getSuperclass()) {
   ...
   public MethodDescriptor[] getMethodDescriptors() {
      ...
      try {
         m = Class.forName("com.l2fprod.common.swing.JLinkButton").getMethods();
