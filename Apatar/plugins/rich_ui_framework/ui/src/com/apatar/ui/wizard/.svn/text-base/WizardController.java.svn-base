...
public class WizardController implements ActionListener {
    ...
    private void nextButtonPressed() {
        ...
        //	model.getCurrentPanelDescriptor().aboutToHidePanel(Wizard.NEXT_BUTTON_ACTION_COMMAND);
            wizard.close(Wizard.FINISH_RETURN_CODE);
        } else { 
        	//model.pushPanel(model.getCurrentPanelDescriptor().getPanelDescriptorIdentifier());
            wizard.setCurrentPanel(nextPanelDescriptor,Wizard.NEXT_BUTTON_ACTION_COMMAND);
        }
    ...
    private void backButtonPressed() {
     ...
     //   Object backPanelDescriptor = descriptor.getBackPanelDescriptor();        
        wizard.setCurrentPanel(model.getCurrentPanelDescriptor().getBackPanelDescriptor(),Wizard.BACK_BUTTON_ACTION_COMMAND);
