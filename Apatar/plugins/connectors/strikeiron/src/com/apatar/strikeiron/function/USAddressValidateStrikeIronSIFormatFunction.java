...
public class USAddressValidateStrikeIronSIFormatFunction extends
	...
	public Object execute(List l) {
		...
		String cityStateZip = (String) l.get(2);
		String firm = (String) l.get(3);
		String urbanization = (String) l.get(4);
	...
	static FunctionInfo fi = new FunctionInfo(
			"Verify US Address (StrikeIron Format)", 5, 0, new String[] {
					"Address Line 1", "Address Line 2", "City State Zip",
					"Firm", "Urbanization" }, null);
	static {
