...
public class FunctionLoder {
	...
	public static void loadFunctionNodesPlugins() {
		...
		Element root;
		try {
			root = ReadWriteXMLData.getRootElement(StrikeironUtils.functionFile);
			for (Object funcObj : root.getChildren("function")) {
				...
				ClassLoader classLoader = StrikeironFunctionNodeFactory.class.getClassLoader();
				Class nodeFactClass = classLoader.loadClass("com.apatar.strikeiron.StrikeironFunctionNodeFactory");
				NodeFactory factory = (StrikeironFunctionNodeFactory)nodeFactClass.getConstructor(
						new Class[]{
								ClassLoader.class,
								String.class
								})
