...
public class EmailVerificationLocator extends org.apache.axis.client.Service implements com.apatar.strikeiron.ws.login.EmailVerification {
 ...
 */
    ...
    private java.lang.String EmailVerificationSoap_address = "http://wsparam.strikeiron.com/StrikeIron/emailverify_3_0/EmailVerification";
    ...
    public com.apatar.strikeiron.ws.login.EmailVerificationSoap_PortType getEmailVerificationSoap() throws javax.xml.rpc.ServiceException {
    ...
    public com.apatar.strikeiron.ws.login.EmailVerificationSoap_PortType getEmailVerificationSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.apatar.strikeiron.ws.login.EmailVerificationSoap_BindingStub _stub = new com.apatar.strikeiron.ws.login.EmailVerificationSoap_BindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.apatar.strikeiron.ws.login.EmailVerificationSoap_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                com.apatar.strikeiron.ws.login.EmailVerificationSoap_BindingStub _stub = new com.apatar.strikeiron.ws.login.EmailVerificationSoap_BindingStub(new java.net.URL(EmailVerificationSoap_address), this);
                _stub.setPortName(getEmailVerificationSoapWSDDServiceName());
                return _stub;
            }
        }
