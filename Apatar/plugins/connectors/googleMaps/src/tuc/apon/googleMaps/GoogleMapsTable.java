...
private String tableName = "";
	...
	private ETableMode mode	= ETableMode.ReadWrite;	//table mode
	
	public GoogleMapsTable(String tableName){
		this.tableName 	  = 	tableName;
	}

	public GoogleMapsTable(String tableName, Map<String, Object> arguments, Map<String,Object> returns){
		this.tableName = tableName;
