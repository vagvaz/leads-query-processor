...
public class SearchResponse  implements java.io.Serializable {
    private com.apatar.salesforcecom.ws.SearchResult result;

    public SearchResponse() {
    }

    public SearchResponse(
           com.apatar.salesforcecom.ws.SearchResult result) {
           this.result = result;
    }
     ...
     * @return result
     */
    public com.apatar.salesforcecom.ws.SearchResult getResult() {
        return result;
    }
     ...
     * @param result
     */
    public void setResult(com.apatar.salesforcecom.ws.SearchResult result) {
        this.result = result;
    }
