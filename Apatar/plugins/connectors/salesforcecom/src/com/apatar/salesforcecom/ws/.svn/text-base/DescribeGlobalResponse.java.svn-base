...
public class DescribeGlobalResponse  implements java.io.Serializable {
    private com.apatar.salesforcecom.ws.DescribeGlobalResult result;

    public DescribeGlobalResponse() {
    }

    public DescribeGlobalResponse(
           com.apatar.salesforcecom.ws.DescribeGlobalResult result) {
           this.result = result;
    }
     ...
     * @return result
     */
    public com.apatar.salesforcecom.ws.DescribeGlobalResult getResult() {
        return result;
    }
     ...
     * @param result
     */
    public void setResult(com.apatar.salesforcecom.ws.DescribeGlobalResult result) {
        this.result = result;
    }
