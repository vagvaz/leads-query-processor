...
public class RecordTypeMapping  implements java.io.Serializable {
    ...
    private com.apatar.salesforcecom.ws.PicklistForRecordType[] picklistsForRecordType;
    ...
    public RecordTypeMapping(
           ...
           com.apatar.salesforcecom.ws.PicklistForRecordType[] picklistsForRecordType,
     ...
     */
    public com.apatar.salesforcecom.ws.PicklistForRecordType[] getPicklistsForRecordType() {
        return picklistsForRecordType;
    }
     ...
     */
    public void setPicklistsForRecordType(com.apatar.salesforcecom.ws.PicklistForRecordType[] picklistsForRecordType) {
        this.picklistsForRecordType = picklistsForRecordType;
    }

    public com.apatar.salesforcecom.ws.PicklistForRecordType getPicklistsForRecordType(int i) {
        return this.picklistsForRecordType[i];
    }

    public void setPicklistsForRecordType(int i, com.apatar.salesforcecom.ws.PicklistForRecordType _value) {
