...
public class ApiFault  extends org.apache.axis.AxisFault  implements java.io.Serializable {
    private com.apatar.salesforcecom.ws.ExceptionCode exceptionCode;
    ...
    public ApiFault(
           com.apatar.salesforcecom.ws.ExceptionCode exceptionCode,
     ...
     */
    public com.apatar.salesforcecom.ws.ExceptionCode getExceptionCode() {
        return exceptionCode;
    }
     ...
     * @param exceptionCode
     */
    public void setExceptionCode(com.apatar.salesforcecom.ws.ExceptionCode exceptionCode) {
        this.exceptionCode = exceptionCode;
    }
