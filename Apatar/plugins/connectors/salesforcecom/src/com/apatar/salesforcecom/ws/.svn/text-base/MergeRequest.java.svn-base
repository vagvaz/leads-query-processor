...
public class MergeRequest  implements java.io.Serializable {
    private com.apatar.salesforcecom.ws.SObject masterRecord;
    ...
    public MergeRequest(
           com.apatar.salesforcecom.ws.SObject masterRecord,
     ...
     * @return masterRecord
     */
    public com.apatar.salesforcecom.ws.SObject getMasterRecord() {
        return masterRecord;
    }
     ...
     * @param masterRecord
     */
    public void setMasterRecord(com.apatar.salesforcecom.ws.SObject masterRecord) {
        this.masterRecord = masterRecord;
    }
