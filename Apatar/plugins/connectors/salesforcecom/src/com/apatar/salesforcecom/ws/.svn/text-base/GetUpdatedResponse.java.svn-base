...
public class GetUpdatedResponse  implements java.io.Serializable {
    private com.apatar.salesforcecom.ws.GetUpdatedResult result;

    public GetUpdatedResponse() {
    }

    public GetUpdatedResponse(
           com.apatar.salesforcecom.ws.GetUpdatedResult result) {
           this.result = result;
    }
     ...
     * @return result
     */
    public com.apatar.salesforcecom.ws.GetUpdatedResult getResult() {
        return result;
    }
     ...
     * @param result
     */
    public void setResult(com.apatar.salesforcecom.ws.GetUpdatedResult result) {
        this.result = result;
    }
