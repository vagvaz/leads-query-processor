/**
 * DescribeDataCategoryGroups.java
 *
...
public class DescribeDataCategoryGroups  implements java.io.Serializable {
    private java.lang.String[] sObjectType;

    public DescribeDataCategoryGroups() {
    }
    ...
    /**
     * Gets the sObjectType value for this DescribeDataCategoryGroups.
     * 
     * @return sObjectType
     */
    ...
    /**
     * Sets the sObjectType value for this DescribeDataCategoryGroups.
     * 
     * @param sObjectType
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof DescribeDataCategoryGroups)) return false;
        DescribeDataCategoryGroups other = (DescribeDataCategoryGroups) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(DescribeDataCategoryGroups.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:partner.soap.sforce.com", ">describeDataCategoryGroups"));
