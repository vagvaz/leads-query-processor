...
public class SearchRecord  implements java.io.Serializable {
    private com.apatar.salesforcecom.ws.SObject record;

    public SearchRecord() {
    }

    public SearchRecord(
           com.apatar.salesforcecom.ws.SObject record) {
           this.record = record;
    }
     ...
     * @return record
     */
    public com.apatar.salesforcecom.ws.SObject getRecord() {
        return record;
    }
     ...
     * @param record
     */
    public void setRecord(com.apatar.salesforcecom.ws.SObject record) {
        this.record = record;
    }
