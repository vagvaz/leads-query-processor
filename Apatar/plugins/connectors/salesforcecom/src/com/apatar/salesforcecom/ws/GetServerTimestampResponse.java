...
public class GetServerTimestampResponse  implements java.io.Serializable {
    private com.apatar.salesforcecom.ws.GetServerTimestampResult result;

    public GetServerTimestampResponse() {
    }

    public GetServerTimestampResponse(
           com.apatar.salesforcecom.ws.GetServerTimestampResult result) {
           this.result = result;
    }
     ...
     * @return result
     */
    public com.apatar.salesforcecom.ws.GetServerTimestampResult getResult() {
        return result;
    }
     ...
     * @param result
     */
    public void setResult(com.apatar.salesforcecom.ws.GetServerTimestampResult result) {
        this.result = result;
    }
