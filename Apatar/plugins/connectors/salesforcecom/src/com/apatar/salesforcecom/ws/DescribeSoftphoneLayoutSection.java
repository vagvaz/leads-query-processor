...
public class DescribeSoftphoneLayoutSection  implements java.io.Serializable {
    ...
    private com.apatar.salesforcecom.ws.DescribeSoftphoneLayoutItem[] items;
    ...
    public DescribeSoftphoneLayoutSection(
           ...
           com.apatar.salesforcecom.ws.DescribeSoftphoneLayoutItem[] items) {
     ...
     * @return items
     */
    public com.apatar.salesforcecom.ws.DescribeSoftphoneLayoutItem[] getItems() {
        return items;
    }
     ...
     * @param items
     */
    public void setItems(com.apatar.salesforcecom.ws.DescribeSoftphoneLayoutItem[] items) {
        this.items = items;
    }

    public com.apatar.salesforcecom.ws.DescribeSoftphoneLayoutItem getItems(int i) {
        return this.items[i];
    }

    public void setItems(int i, com.apatar.salesforcecom.ws.DescribeSoftphoneLayoutItem _value) {
        this.items[i] = _value;
    }
