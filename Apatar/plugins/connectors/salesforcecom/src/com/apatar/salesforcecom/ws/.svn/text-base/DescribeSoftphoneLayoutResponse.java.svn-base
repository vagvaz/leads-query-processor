...
public class DescribeSoftphoneLayoutResponse  implements java.io.Serializable {
    private com.apatar.salesforcecom.ws.DescribeSoftphoneLayoutResult result;

    public DescribeSoftphoneLayoutResponse() {
    }

    public DescribeSoftphoneLayoutResponse(
           com.apatar.salesforcecom.ws.DescribeSoftphoneLayoutResult result) {
           this.result = result;
    }
     ...
     * @return result
     */
    public com.apatar.salesforcecom.ws.DescribeSoftphoneLayoutResult getResult() {
        return result;
    }
     ...
     * @param result
     */
    public void setResult(com.apatar.salesforcecom.ws.DescribeSoftphoneLayoutResult result) {
        this.result = result;
    }
