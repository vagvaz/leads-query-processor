...
public class QueryResult  implements java.io.Serializable {
    ...
    private com.apatar.salesforcecom.ws.SObject[] records;
    ...
    public QueryResult(
           ...
           com.apatar.salesforcecom.ws.SObject[] records,
           int size) {
           this.done = done;
     ...
     * @return records
     */
    public com.apatar.salesforcecom.ws.SObject[] getRecords() {
        return records;
    }
     ...
     * @param records
     */
    public void setRecords(com.apatar.salesforcecom.ws.SObject[] records) {
        this.records = records;
    }

    public com.apatar.salesforcecom.ws.SObject getRecords(int i) {
        return this.records[i];
    }

    public void setRecords(int i, com.apatar.salesforcecom.ws.SObject _value) {
