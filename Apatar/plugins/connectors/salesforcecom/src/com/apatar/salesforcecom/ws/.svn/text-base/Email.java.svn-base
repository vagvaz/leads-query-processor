...
public class Email  implements java.io.Serializable {
    ...
    private com.apatar.salesforcecom.ws.EmailPriority emailPriority;
     ...
     */
    public com.apatar.salesforcecom.ws.EmailPriority getEmailPriority() {
        return emailPriority;
    }
     ...
     * @param emailPriority
     */
    public void setEmailPriority(com.apatar.salesforcecom.ws.EmailPriority emailPriority) {
        this.emailPriority = emailPriority;
    }
