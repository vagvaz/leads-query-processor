...
public class Delete  implements java.io.Serializable {
    ...
    /**
     * Gets the ids value for this Delete.
     * 
     * @return ids
     */
    ...
    /**
     * Sets the ids value for this Delete.
     * 
     * @param ids
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:partner.soap.sforce.com", ">delete"));
