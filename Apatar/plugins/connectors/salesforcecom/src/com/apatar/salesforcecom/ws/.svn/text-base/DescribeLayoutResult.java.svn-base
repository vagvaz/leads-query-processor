...
public class DescribeLayoutResult  implements java.io.Serializable {
    private com.apatar.salesforcecom.ws.DescribeLayout[] layouts;

    private com.apatar.salesforcecom.ws.RecordTypeMapping[] recordTypeMappings;
    ...
    public DescribeLayoutResult(
           com.apatar.salesforcecom.ws.DescribeLayout[] layouts,
           com.apatar.salesforcecom.ws.RecordTypeMapping[] recordTypeMappings,
     ...
     * @return layouts
     */
    public com.apatar.salesforcecom.ws.DescribeLayout[] getLayouts() {
        return layouts;
    }
     ...
     * @param layouts
     */
    public void setLayouts(com.apatar.salesforcecom.ws.DescribeLayout[] layouts) {
        this.layouts = layouts;
    }

    public com.apatar.salesforcecom.ws.DescribeLayout getLayouts(int i) {
        return this.layouts[i];
    }

    public void setLayouts(int i, com.apatar.salesforcecom.ws.DescribeLayout _value) {
     ...
     */
    public com.apatar.salesforcecom.ws.RecordTypeMapping[] getRecordTypeMappings() {
        return recordTypeMappings;
    }
     ...
     */
    public void setRecordTypeMappings(com.apatar.salesforcecom.ws.RecordTypeMapping[] recordTypeMappings) {
        this.recordTypeMappings = recordTypeMappings;
    }

    public com.apatar.salesforcecom.ws.RecordTypeMapping getRecordTypeMappings(int i) {
        return this.recordTypeMappings[i];
    }

    public void setRecordTypeMappings(int i, com.apatar.salesforcecom.ws.RecordTypeMapping _value) {
