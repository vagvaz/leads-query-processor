...
public class ProcessResult  implements java.io.Serializable {
    ...
    private com.apatar.salesforcecom.ws.Error[] errors;
    ...
    public ProcessResult(
           ...
           com.apatar.salesforcecom.ws.Error[] errors,
     ...
     * @return errors
     */
    public com.apatar.salesforcecom.ws.Error[] getErrors() {
        return errors;
    }
     ...
     * @param errors
     */
    public void setErrors(com.apatar.salesforcecom.ws.Error[] errors) {
        this.errors = errors;
    }

    public com.apatar.salesforcecom.ws.Error getErrors(int i) {
        return this.errors[i];
    }

    public void setErrors(int i, com.apatar.salesforcecom.ws.Error _value) {
