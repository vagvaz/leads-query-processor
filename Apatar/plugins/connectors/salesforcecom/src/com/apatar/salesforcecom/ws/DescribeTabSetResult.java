...
public class DescribeTabSetResult  implements java.io.Serializable {
    ...
    private com.apatar.salesforcecom.ws.DescribeTab[] tabs;
    ...
    public DescribeTabSetResult(
           ...
           boolean selected,
           com.apatar.salesforcecom.ws.DescribeTab[] tabs) {
           this.label = label;
     ...
     * @return tabs
     */
    public com.apatar.salesforcecom.ws.DescribeTab[] getTabs() {
        return tabs;
    }
     ...
     * @param tabs
     */
    public void setTabs(com.apatar.salesforcecom.ws.DescribeTab[] tabs) {
        this.tabs = tabs;
    }

    public com.apatar.salesforcecom.ws.DescribeTab getTabs(int i) {
        return this.tabs[i];
    }

    public void setTabs(int i, com.apatar.salesforcecom.ws.DescribeTab _value) {
        this.tabs[i] = _value;
    }
