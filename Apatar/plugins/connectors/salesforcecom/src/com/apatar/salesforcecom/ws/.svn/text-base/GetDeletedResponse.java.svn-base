...
public class GetDeletedResponse  implements java.io.Serializable {
    private com.apatar.salesforcecom.ws.GetDeletedResult result;

    public GetDeletedResponse() {
    }

    public GetDeletedResponse(
           com.apatar.salesforcecom.ws.GetDeletedResult result) {
           this.result = result;
    }
     ...
     * @return result
     */
    public com.apatar.salesforcecom.ws.GetDeletedResult getResult() {
        return result;
    }
     ...
     * @param result
     */
    public void setResult(com.apatar.salesforcecom.ws.GetDeletedResult result) {
        this.result = result;
    }
