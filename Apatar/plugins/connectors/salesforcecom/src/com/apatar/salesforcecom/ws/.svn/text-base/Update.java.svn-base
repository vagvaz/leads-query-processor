...
public class Update  implements java.io.Serializable {
    ...
    /**
     * Gets the sObjects value for this Update.
     * 
     * @return sObjects
     */
    ...
    /**
     * Sets the sObjects value for this Update.
     * 
     * @param sObjects
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:partner.soap.sforce.com", ">update"));
