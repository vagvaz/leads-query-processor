...
public class RelatedList  implements java.io.Serializable {
    private com.apatar.salesforcecom.ws.RelatedListColumn[] columns;
    ...
    private com.apatar.salesforcecom.ws.RelatedListSort[] sort;

    public RelatedList() {
    }

    public RelatedList(
           com.apatar.salesforcecom.ws.RelatedListColumn[] columns,
           boolean custom,
           ...
           com.apatar.salesforcecom.ws.RelatedListSort[] sort) {
     ...
     * @return columns
     */
    public com.apatar.salesforcecom.ws.RelatedListColumn[] getColumns() {
        return columns;
    }
     ...
     * @param columns
     */
    public void setColumns(com.apatar.salesforcecom.ws.RelatedListColumn[] columns) {
        this.columns = columns;
    }

    public com.apatar.salesforcecom.ws.RelatedListColumn getColumns(int i) {
        return this.columns[i];
    }

    public void setColumns(int i, com.apatar.salesforcecom.ws.RelatedListColumn _value) {
     ...
     * @return sort
     */
    public com.apatar.salesforcecom.ws.RelatedListSort[] getSort() {
        return sort;
    }
     ...
     * @param sort
     */
    public void setSort(com.apatar.salesforcecom.ws.RelatedListSort[] sort) {
        this.sort = sort;
    }

    public com.apatar.salesforcecom.ws.RelatedListSort getSort(int i) {
        return this.sort[i];
    }

    public void setSort(int i, com.apatar.salesforcecom.ws.RelatedListSort _value) {
        this.sort[i] = _value;
    }
