...
public class DescribeLayoutResponse  implements java.io.Serializable {
    private com.apatar.salesforcecom.ws.DescribeLayoutResult result;

    public DescribeLayoutResponse() {
    }

    public DescribeLayoutResponse(
           com.apatar.salesforcecom.ws.DescribeLayoutResult result) {
           this.result = result;
    }
     ...
     * @return result
     */
    public com.apatar.salesforcecom.ws.DescribeLayoutResult getResult() {
        return result;
    }
     ...
     * @param result
     */
    public void setResult(com.apatar.salesforcecom.ws.DescribeLayoutResult result) {
        this.result = result;
    }
