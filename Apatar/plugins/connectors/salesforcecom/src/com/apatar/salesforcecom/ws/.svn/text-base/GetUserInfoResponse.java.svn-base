...
public class GetUserInfoResponse  implements java.io.Serializable {
    private com.apatar.salesforcecom.ws.GetUserInfoResult result;

    public GetUserInfoResponse() {
    }

    public GetUserInfoResponse(
           com.apatar.salesforcecom.ws.GetUserInfoResult result) {
           this.result = result;
    }
     ...
     * @return result
     */
    public com.apatar.salesforcecom.ws.GetUserInfoResult getResult() {
        return result;
    }
     ...
     * @param result
     */
    public void setResult(com.apatar.salesforcecom.ws.GetUserInfoResult result) {
        this.result = result;
    }
