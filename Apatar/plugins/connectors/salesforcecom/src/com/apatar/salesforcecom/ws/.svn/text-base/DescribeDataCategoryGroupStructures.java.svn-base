...
public class DescribeDataCategoryGroupStructures  implements java.io.Serializable {
    private com.apatar.salesforcecom.ws.DataCategoryGroupSobjectTypePair[] pairs;
    ...
    public DescribeDataCategoryGroupStructures(
           com.apatar.salesforcecom.ws.DataCategoryGroupSobjectTypePair[] pairs,
     ...
     * @return pairs
     */
    public com.apatar.salesforcecom.ws.DataCategoryGroupSobjectTypePair[] getPairs() {
        return pairs;
    }
     ...
     * @param pairs
     */
    public void setPairs(com.apatar.salesforcecom.ws.DataCategoryGroupSobjectTypePair[] pairs) {
        this.pairs = pairs;
    }

    public com.apatar.salesforcecom.ws.DataCategoryGroupSobjectTypePair getPairs(int i) {
        return this.pairs[i];
    }

    public void setPairs(int i, com.apatar.salesforcecom.ws.DataCategoryGroupSobjectTypePair _value) {
        this.pairs[i] = _value;
    }
