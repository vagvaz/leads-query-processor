...
public class DataCategory  implements java.io.Serializable {
    private com.apatar.salesforcecom.ws.DataCategory[] childCategories;
    ...
    public DataCategory(
           com.apatar.salesforcecom.ws.DataCategory[] childCategories,
     ...
     */
    public com.apatar.salesforcecom.ws.DataCategory[] getChildCategories() {
        return childCategories;
    }
     ...
     */
    public void setChildCategories(com.apatar.salesforcecom.ws.DataCategory[] childCategories) {
        this.childCategories = childCategories;
    }

    public com.apatar.salesforcecom.ws.DataCategory getChildCategories(int i) {
        return this.childCategories[i];
    }

    public void setChildCategories(int i, com.apatar.salesforcecom.ws.DataCategory _value) {
