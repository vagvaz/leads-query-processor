...
public class QueryResponse  implements java.io.Serializable {
    private com.apatar.salesforcecom.ws.QueryResult result;

    public QueryResponse() {
    }

    public QueryResponse(
           com.apatar.salesforcecom.ws.QueryResult result) {
           this.result = result;
    }
     ...
     * @return result
     */
    public com.apatar.salesforcecom.ws.QueryResult getResult() {
        return result;
    }
     ...
     * @param result
     */
    public void setResult(com.apatar.salesforcecom.ws.QueryResult result) {
        this.result = result;
    }
