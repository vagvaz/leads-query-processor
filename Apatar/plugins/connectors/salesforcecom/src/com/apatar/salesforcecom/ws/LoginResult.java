...
public class LoginResult  implements java.io.Serializable {
    ...
    private com.apatar.salesforcecom.ws.GetUserInfoResult userInfo;
    ...
    public LoginResult(
           ...
           com.apatar.salesforcecom.ws.GetUserInfoResult userInfo) {
     ...
     * @return userInfo
     */
    public com.apatar.salesforcecom.ws.GetUserInfoResult getUserInfo() {
        return userInfo;
    }
     ...
     * @param userInfo
     */
    public void setUserInfo(com.apatar.salesforcecom.ws.GetUserInfoResult userInfo) {
        this.userInfo = userInfo;
    }
