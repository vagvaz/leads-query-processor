...
public class SetPasswordResponse  implements java.io.Serializable {
    private com.apatar.salesforcecom.ws.SetPasswordResult result;

    public SetPasswordResponse() {
    }

    public SetPasswordResponse(
           com.apatar.salesforcecom.ws.SetPasswordResult result) {
           this.result = result;
    }
     ...
     * @return result
     */
    public com.apatar.salesforcecom.ws.SetPasswordResult getResult() {
        return result;
    }
     ...
     * @param result
     */
    public void setResult(com.apatar.salesforcecom.ws.SetPasswordResult result) {
        this.result = result;
    }
