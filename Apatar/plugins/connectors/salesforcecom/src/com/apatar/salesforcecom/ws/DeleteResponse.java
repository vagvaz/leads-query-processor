...
public class DeleteResponse  implements java.io.Serializable {
    private com.apatar.salesforcecom.ws.DeleteResult[] result;

    public DeleteResponse() {
    }

    public DeleteResponse(
           com.apatar.salesforcecom.ws.DeleteResult[] result) {
           this.result = result;
    }
     ...
     * @return result
     */
    public com.apatar.salesforcecom.ws.DeleteResult[] getResult() {
        return result;
    }
     ...
     * @param result
     */
    public void setResult(com.apatar.salesforcecom.ws.DeleteResult[] result) {
        this.result = result;
    }

    public com.apatar.salesforcecom.ws.DeleteResult getResult(int i) {
        return this.result[i];
    }

    public void setResult(int i, com.apatar.salesforcecom.ws.DeleteResult _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:partner.soap.sforce.com", ">deleteResponse"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("result");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:partner.soap.sforce.com", "result"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:partner.soap.sforce.com", "DeleteResult"));
