...
public class DescribeSoftphoneLayoutCallType  implements java.io.Serializable {
    private com.apatar.salesforcecom.ws.DescribeSoftphoneLayoutInfoField[] infoFields;

    private java.lang.String name;

    private com.apatar.salesforcecom.ws.DescribeSoftphoneScreenPopOption[] screenPopOptions;

    private java.lang.String screenPopsOpenWithin;

    private com.apatar.salesforcecom.ws.DescribeSoftphoneLayoutSection[] sections;

    public DescribeSoftphoneLayoutCallType() {
    }

    public DescribeSoftphoneLayoutCallType(
           com.apatar.salesforcecom.ws.DescribeSoftphoneLayoutInfoField[] infoFields,
           java.lang.String name,
           com.apatar.salesforcecom.ws.DescribeSoftphoneScreenPopOption[] screenPopOptions,
           java.lang.String screenPopsOpenWithin,
           com.apatar.salesforcecom.ws.DescribeSoftphoneLayoutSection[] sections) {
     ...
     * @return infoFields
     */
    public com.apatar.salesforcecom.ws.DescribeSoftphoneLayoutInfoField[] getInfoFields() {
        return infoFields;
    }
     ...
     * @param infoFields
     */
    public void setInfoFields(com.apatar.salesforcecom.ws.DescribeSoftphoneLayoutInfoField[] infoFields) {
        this.infoFields = infoFields;
    }

    public com.apatar.salesforcecom.ws.DescribeSoftphoneLayoutInfoField getInfoFields(int i) {
        return this.infoFields[i];
    }

    public void setInfoFields(int i, com.apatar.salesforcecom.ws.DescribeSoftphoneLayoutInfoField _value) {
     ...
     */
    public com.apatar.salesforcecom.ws.DescribeSoftphoneScreenPopOption[] getScreenPopOptions() {
        return screenPopOptions;
    }
     ...
     */
    public void setScreenPopOptions(com.apatar.salesforcecom.ws.DescribeSoftphoneScreenPopOption[] screenPopOptions) {
        this.screenPopOptions = screenPopOptions;
    }

    public com.apatar.salesforcecom.ws.DescribeSoftphoneScreenPopOption getScreenPopOptions(int i) {
        return this.screenPopOptions[i];
    }

    public void setScreenPopOptions(int i, com.apatar.salesforcecom.ws.DescribeSoftphoneScreenPopOption _value) {
     ...
     * @return sections
     */
    public com.apatar.salesforcecom.ws.DescribeSoftphoneLayoutSection[] getSections() {
        return sections;
    }
     ...
     * @param sections
     */
    public void setSections(com.apatar.salesforcecom.ws.DescribeSoftphoneLayoutSection[] sections) {
        this.sections = sections;
    }

    public com.apatar.salesforcecom.ws.DescribeSoftphoneLayoutSection getSections(int i) {
        return this.sections[i];
    }

    public void setSections(int i, com.apatar.salesforcecom.ws.DescribeSoftphoneLayoutSection _value) {
