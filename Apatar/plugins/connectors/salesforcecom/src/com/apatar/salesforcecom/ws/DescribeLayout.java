...
public class DescribeLayout  implements java.io.Serializable {
    private com.apatar.salesforcecom.ws.DescribeLayoutButtonSection buttonLayoutSection;

    private com.apatar.salesforcecom.ws.DescribeLayoutSection[] detailLayoutSections;

    private com.apatar.salesforcecom.ws.DescribeLayoutSection[] editLayoutSections;

    private java.lang.String id;

    private com.apatar.salesforcecom.ws.RelatedList[] relatedLists;

    public DescribeLayout() {
    }

    public DescribeLayout(
           com.apatar.salesforcecom.ws.DescribeLayoutButtonSection buttonLayoutSection,
           com.apatar.salesforcecom.ws.DescribeLayoutSection[] detailLayoutSections,
           com.apatar.salesforcecom.ws.DescribeLayoutSection[] editLayoutSections,
           java.lang.String id,
           com.apatar.salesforcecom.ws.RelatedList[] relatedLists) {
     ...
     */
    public com.apatar.salesforcecom.ws.DescribeLayoutButtonSection getButtonLayoutSection() {
        return buttonLayoutSection;
    }
     ...
     */
    public void setButtonLayoutSection(com.apatar.salesforcecom.ws.DescribeLayoutButtonSection buttonLayoutSection) {
        this.buttonLayoutSection = buttonLayoutSection;
    }
     ...
     */
    public com.apatar.salesforcecom.ws.DescribeLayoutSection[] getDetailLayoutSections() {
        return detailLayoutSections;
    }
     ...
     */
    public void setDetailLayoutSections(com.apatar.salesforcecom.ws.DescribeLayoutSection[] detailLayoutSections) {
        this.detailLayoutSections = detailLayoutSections;
    }

    public com.apatar.salesforcecom.ws.DescribeLayoutSection getDetailLayoutSections(int i) {
        return this.detailLayoutSections[i];
    }

    public void setDetailLayoutSections(int i, com.apatar.salesforcecom.ws.DescribeLayoutSection _value) {
     ...
     */
    public com.apatar.salesforcecom.ws.DescribeLayoutSection[] getEditLayoutSections() {
        return editLayoutSections;
    }
     ...
     */
    public void setEditLayoutSections(com.apatar.salesforcecom.ws.DescribeLayoutSection[] editLayoutSections) {
        this.editLayoutSections = editLayoutSections;
    }

    public com.apatar.salesforcecom.ws.DescribeLayoutSection getEditLayoutSections(int i) {
        return this.editLayoutSections[i];
    }

    public void setEditLayoutSections(int i, com.apatar.salesforcecom.ws.DescribeLayoutSection _value) {
     ...
     * @return relatedLists
     */
    public com.apatar.salesforcecom.ws.RelatedList[] getRelatedLists() {
        return relatedLists;
    }
     ...
     * @param relatedLists
     */
    public void setRelatedLists(com.apatar.salesforcecom.ws.RelatedList[] relatedLists) {
        this.relatedLists = relatedLists;
    }

    public com.apatar.salesforcecom.ws.RelatedList getRelatedLists(int i) {
        return this.relatedLists[i];
    }

    public void setRelatedLists(int i, com.apatar.salesforcecom.ws.RelatedList _value) {
        ...
        _equals = true && 
            ((this.buttonLayoutSection==null && other.getButtonLayoutSection()==null) || 
             (this.buttonLayoutSection!=null &&
              this.buttonLayoutSection.equals(other.getButtonLayoutSection()))) &&
    ...
    public synchronized int hashCode() {
        ...
        if (getButtonLayoutSection() != null) {
            _hashCode += getButtonLayoutSection().hashCode();
        }
    ...
    static {
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:partner.soap.sforce.com", "DescribeLayoutButtonSection"));
