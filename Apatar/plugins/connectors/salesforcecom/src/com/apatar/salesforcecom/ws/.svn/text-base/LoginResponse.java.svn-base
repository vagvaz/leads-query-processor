...
public class LoginResponse  implements java.io.Serializable {
    private com.apatar.salesforcecom.ws.LoginResult result;

    public LoginResponse() {
    }

    public LoginResponse(
           com.apatar.salesforcecom.ws.LoginResult result) {
           this.result = result;
    }
     ...
     * @return result
     */
    public com.apatar.salesforcecom.ws.LoginResult getResult() {
        return result;
    }
     ...
     * @param result
     */
    public void setResult(com.apatar.salesforcecom.ws.LoginResult result) {
        this.result = result;
    }
