...
public class ResetPasswordResponse  implements java.io.Serializable {
    private com.apatar.salesforcecom.ws.ResetPasswordResult result;

    public ResetPasswordResponse() {
    }

    public ResetPasswordResponse(
           com.apatar.salesforcecom.ws.ResetPasswordResult result) {
           this.result = result;
    }
     ...
     * @return result
     */
    public com.apatar.salesforcecom.ws.ResetPasswordResult getResult() {
        return result;
    }
     ...
     * @param result
     */
    public void setResult(com.apatar.salesforcecom.ws.ResetPasswordResult result) {
        this.result = result;
    }
