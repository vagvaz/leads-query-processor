...
public class DescribeGlobalResult  implements java.io.Serializable {
    ...
    private com.apatar.salesforcecom.ws.DescribeGlobalSObjectResult[] sobjects;
    ...
    public DescribeGlobalResult(
           ...
           int maxBatchSize,
           com.apatar.salesforcecom.ws.DescribeGlobalSObjectResult[] sobjects) {
     ...
     * @return sobjects
     */
    public com.apatar.salesforcecom.ws.DescribeGlobalSObjectResult[] getSobjects() {
        return sobjects;
    }
     ...
     * @param sobjects
     */
    public void setSobjects(com.apatar.salesforcecom.ws.DescribeGlobalSObjectResult[] sobjects) {
        this.sobjects = sobjects;
    }

    public com.apatar.salesforcecom.ws.DescribeGlobalSObjectResult getSobjects(int i) {
        return this.sobjects[i];
    }

    public void setSobjects(int i, com.apatar.salesforcecom.ws.DescribeGlobalSObjectResult _value) {
