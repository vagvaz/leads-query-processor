...
public class Error  implements java.io.Serializable {
    ...
    private com.apatar.salesforcecom.ws.StatusCode statusCode;
    ...
    public Error(
           ...
           com.apatar.salesforcecom.ws.StatusCode statusCode) {
           this.fields = fields;
     ...
     * @return statusCode
     */
    public com.apatar.salesforcecom.ws.StatusCode getStatusCode() {
        return statusCode;
    }
     ...
     * @param statusCode
     */
    public void setStatusCode(com.apatar.salesforcecom.ws.StatusCode statusCode) {
        this.statusCode = statusCode;
    }
