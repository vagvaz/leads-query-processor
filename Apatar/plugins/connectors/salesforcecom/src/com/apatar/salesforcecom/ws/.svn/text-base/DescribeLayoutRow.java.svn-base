...
public class DescribeLayoutRow  implements java.io.Serializable {
    private com.apatar.salesforcecom.ws.DescribeLayoutItem[] layoutItems;
    ...
    public DescribeLayoutRow(
           com.apatar.salesforcecom.ws.DescribeLayoutItem[] layoutItems,
           int numItems) {
     ...
     * @return layoutItems
     */
    public com.apatar.salesforcecom.ws.DescribeLayoutItem[] getLayoutItems() {
        return layoutItems;
    }
     ...
     * @param layoutItems
     */
    public void setLayoutItems(com.apatar.salesforcecom.ws.DescribeLayoutItem[] layoutItems) {
        this.layoutItems = layoutItems;
    }

    public com.apatar.salesforcecom.ws.DescribeLayoutItem getLayoutItems(int i) {
        return this.layoutItems[i];
    }

    public void setLayoutItems(int i, com.apatar.salesforcecom.ws.DescribeLayoutItem _value) {
