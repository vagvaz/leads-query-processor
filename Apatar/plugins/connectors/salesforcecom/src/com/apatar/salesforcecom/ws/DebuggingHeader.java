...
public class DebuggingHeader  implements java.io.Serializable {
    private com.apatar.salesforcecom.ws.DebugLevel debugLevel;

    public DebuggingHeader() {
    }

    public DebuggingHeader(
           com.apatar.salesforcecom.ws.DebugLevel debugLevel) {
     ...
     * @return debugLevel
     */
    public com.apatar.salesforcecom.ws.DebugLevel getDebugLevel() {
        return debugLevel;
    }
     ...
     * @param debugLevel
     */
    public void setDebugLevel(com.apatar.salesforcecom.ws.DebugLevel debugLevel) {
        this.debugLevel = debugLevel;
    }
