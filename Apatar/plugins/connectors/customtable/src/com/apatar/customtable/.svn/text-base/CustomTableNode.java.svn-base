...
public class CustomTableNode extends AbstractNonJdbcDataBaseNode {
	...
	static {
		...
		rcList.add(new DBTypeRecord(ERecordType.Text, "VARCHAR_IGNORECASE", 1,
				255, false, false));
		rcList.add(new DBTypeRecord(ERecordType.LongText, "LONGVARCHAR", 1,
				255, false, false));
		...
		rcList.add(new DBTypeRecord(ERecordType.Binary, "BINARY", 0, 65535,
				false, false));
		rcList.add(new DBTypeRecord(ERecordType.Clob, "CLOB", 0, 65535, false,
				false));
		rcList.add(new DBTypeRecord(ERecordType.VarBinary, "VARBINARY", 0,
				65535, false, false));
		rcList.add(new DBTypeRecord(ERecordType.LongVarBinary, "LONGVARBINARY",
				0, 65535, false, false));
	...
	public void createDatabaseParam(Wizard wizard) {
		...
		TableSchemaDescriptor descriptor1 = new TableSchemaDescriptor(
