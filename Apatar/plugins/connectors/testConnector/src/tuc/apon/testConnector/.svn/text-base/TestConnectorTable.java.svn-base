...
public class TestConnectorTable {
	...
	public TestConnectorTable(String tableName){
		this.tableName 	  = 	tableName;
	}

	public TestConnectorTable(String tableName, Map<String, Object> arguments, Map<String,Object> returns){
		this.tableName = tableName;
