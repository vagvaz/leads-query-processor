...
public class TestConnectorTableList {
	...
	static{
		...
		testConnectorTables.put("Webpages", new TestConnectorTable("Webpages",arguments,returns));
		...
		testConnectorTables.put("Entities", new TestConnectorTable("Entities",arguments,returns));
