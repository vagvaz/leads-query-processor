...
import com.apatar.webdav.WebDavConnection;
import com.apatar.webdav.WebDavNode;

public class WebDavFolderTreeDescriptor extends WizardPanelDescriptor {
	
	public static final String IDENTIFIER = "WEBDAV_TREE_MODE_PANEL";
	...
	public WebDavFolderTreeDescriptor(WebDavNode node, Object backDescriptor,
			Object nextDescriptor){
		super();
    ...
    public void aboutToDisplayPanel() {
		...
		WebDavConnection conn = node.getConnectionInfo();
