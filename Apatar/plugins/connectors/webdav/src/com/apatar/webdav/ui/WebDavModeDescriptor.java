...
public class WebDavModeDescriptor extends WizardPanelDescriptor {
	
	public static final String IDENTIFIER = "WEBDAVMODE_PANEL";
	
	JWebDavModePanel panel = new JWebDavModePanel();
	Object backDescriptor;
	Object nextDescriptor;
	AbstractDataBaseNode node = null;
	
	public WebDavModeDescriptor(AbstractDataBaseNode node, Object backDescriptor, Object nextDescriptor) {
		super();
