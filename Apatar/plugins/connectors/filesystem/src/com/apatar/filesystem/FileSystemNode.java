...
public class FileSystemNode extends AbstractNonJdbcDataBaseNode {
	...
	protected void TransformRDBtoTDB() {
		...
		FileParams fp = ((FileParams) ApplicationData.getProject()
	...
	public void createDatabaseParam(Wizard wizard) {
		...
		try {
			WizardPanelDescriptor descriptor1 = new DBConnectionDescriptor(
					...
					FSModeDescriptor.IDENTIFIER, ApplicationData
							.classForName("com.apatar.filesystem.FileParams"),
					"db_connector", "filesystem");
			wizard.registerWizardPanel(DBConnectionDescriptor.IDENTIFIER,
					descriptor1);

			WizardPanelDescriptor descriptor2 = new FSModeDescriptor(this,
					DBConnectionDescriptor.IDENTIFIER,
					WizardPanelDescriptor.FINISH);
			wizard
					.registerWizardPanel(FSModeDescriptor.IDENTIFIER,
							descriptor2);
	...
	public ImageIcon getIcon() {
		return FileSystemUtils.READ_FS_NODE_ICON;
	}
	...
	public boolean validateConnectionData() {
		FileParams params = (FileParams) ApplicationData.getProject()
