...
public class WorkbookGetRequest implements java.io.Serializable {
	/**
	 * 
	 */
	private static final long	serialVersionUID	= 4845827398556376155L;
	private java.lang.String	sessionKey;
	private java.lang.String	workbook;

	public WorkbookGetRequest() {
	}

	public WorkbookGetRequest(java.lang.String sessionKey,
	...
	/**
	 * Gets the sessionKey value for this WorkbookGetRequest.
	 * 
	 * @return sessionKey
	 */
	...
	/**
	 * Sets the sessionKey value for this WorkbookGetRequest.
	 * 
	 * @param sessionKey
	 */
	...
	/**
	 * Gets the workbook value for this WorkbookGetRequest.
	 * 
	 * @return workbook
	 */
	...
	/**
	 * Sets the workbook value for this WorkbookGetRequest.
	 * 
	 * @param workbook
	 */
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof WorkbookGetRequest)) {
			return false;
		}
		WorkbookGetRequest other = (WorkbookGetRequest) obj;
		if (obj == null) {
			return false;
		}
		if (this == obj) {
	...
	private static org.apache.axis.description.TypeDesc	typeDesc	= new org.apache.axis.description.TypeDesc(
																			WorkbookGetRequest.class,
																			true);

	static {
		typeDesc.setXmlType(new javax.xml.namespace.QName(
				"http://api.editgrid.com", "WorkbookGetRequest"));
