 ...
 */
public class WorksheetModePanel extends JPanel {

	/**
	 *
	 */
	private static final long	serialVersionUID	= 7821496813314286860L;
	...
	JCheckBox					isDeleteAll			= new JCheckBox(
															"Clear the selected table before insert.");
	JCheckBox					isSkipReadOnInsert	= new JCheckBox(
															"Skip read before insert.");
	JRadioButton				insertMode			= new JRadioButton(
															"Insert Mode");
	JRadioButton				updateMode			= new JRadioButton(
															"Update Mode");
	JRadioButton				syncMode			= new JRadioButton(
															"Synchronization Mode");

	public WorksheetModePanel() {
		super();
		createPanel();
	...
	private void createPanel() {
		...
		deletePanel.add(isSkipReadOnInsert);
	...
	/**
	 * @return the isSkipReadOnInsert
	 */
	public boolean getIsSkipReadOnInsert() {
		return isSkipReadOnInsert.isSelected();
	}

	/**
	 * @param isSkipReadOnInsert
	 *        the isSkipReadOnInsert to set
	 */
	public void setIsSkipReadOnInsert(boolean isSkipReadOnInsert) {
		this.isSkipReadOnInsert.setSelected(isSkipReadOnInsert);
	}
