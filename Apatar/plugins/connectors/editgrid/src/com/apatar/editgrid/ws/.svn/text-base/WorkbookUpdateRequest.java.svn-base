...
public class WorkbookUpdateRequest implements java.io.Serializable {
	/**
	 * 
	 */
	private static final long				serialVersionUID	= -1037106586069679614L;
	private java.lang.String				sessionKey;
	private java.lang.String				workbook;
	private com.apatar.editgrid.ws.Workbook	body;

	public WorkbookUpdateRequest() {
	}

	public WorkbookUpdateRequest(java.lang.String sessionKey,
			java.lang.String workbook, com.apatar.editgrid.ws.Workbook body) {
	...
	/**
	 * Gets the sessionKey value for this WorkbookUpdateRequest.
	 * 
	 * @return sessionKey
	 */
	...
	/**
	 * Sets the sessionKey value for this WorkbookUpdateRequest.
	 * 
	 * @param sessionKey
	 */
	...
	/**
	 * Gets the workbook value for this WorkbookUpdateRequest.
	 * 
	 * @return workbook
	 */
	...
	/**
	 * Sets the workbook value for this WorkbookUpdateRequest.
	 * 
	 * @param workbook
	 */
	...
	/**
	 * Gets the body value for this WorkbookUpdateRequest.
	 * 
	 * @return body
	 */
	...
	/**
	 * Sets the body value for this WorkbookUpdateRequest.
	 * 
	 * @param body
	 */
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof WorkbookUpdateRequest)) {
			return false;
		}
		WorkbookUpdateRequest other = (WorkbookUpdateRequest) obj;
		if (obj == null) {
			return false;
		}
		if (this == obj) {
	...
	private static org.apache.axis.description.TypeDesc	typeDesc	= new org.apache.axis.description.TypeDesc(
																			WorkbookUpdateRequest.class,
																			true);

	static {
		typeDesc.setXmlType(new javax.xml.namespace.QName(
				"http://api.editgrid.com", "WorkbookUpdateRequest"));
