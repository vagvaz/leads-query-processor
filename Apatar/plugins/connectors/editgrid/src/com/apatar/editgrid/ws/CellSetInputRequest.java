...
public class CellSetInputRequest implements java.io.Serializable {
	/**
	 * 
	 */
	private static final long	serialVersionUID	= -6805087058610719530L;
	...
	public CellSetInputRequest() {
	}

	public CellSetInputRequest(java.lang.String sessionKey,
			java.lang.String workbook, java.lang.String range,
			java.lang.String returnRange, java.lang.String input) {
	...
	/**
	 * Gets the sessionKey value for this CellSetInputRequest.
	 * 
	 * @return sessionKey
	 */
	...
	/**
	 * Sets the sessionKey value for this CellSetInputRequest.
	 * 
	 * @param sessionKey
	 */
	...
	/**
	 * Gets the workbook value for this CellSetInputRequest.
	 * 
	 * @return workbook
	 */
	...
	/**
	 * Sets the workbook value for this CellSetInputRequest.
	 * 
	 * @param workbook
	 */
	...
	/**
	 * Gets the range value for this CellSetInputRequest.
	 * 
	 * @return range
	 */
	...
	/**
	 * Sets the range value for this CellSetInputRequest.
	 * 
	 * @param range
	 */
	...
	/**
	 * Gets the returnRange value for this CellSetInputRequest.
	 * 
	 * @return returnRange
	 */
	...
	/**
	 * Sets the returnRange value for this CellSetInputRequest.
	 * 
	 * @param returnRange
	 */
	...
	/**
	 * Gets the input value for this CellSetInputRequest.
	 * 
	 * @return input
	 */
	...
	/**
	 * Sets the input value for this CellSetInputRequest.
	 * 
	 * @param input
	 */
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof CellSetInputRequest)) {
			return false;
		}
		CellSetInputRequest other = (CellSetInputRequest) obj;
		if (obj == null) {
			return false;
		}
		if (this == obj) {
	...
	private static org.apache.axis.description.TypeDesc	typeDesc	= new org.apache.axis.description.TypeDesc(
																			CellSetInputRequest.class,
																			true);

	static {
		typeDesc.setXmlType(new javax.xml.namespace.QName(
				"http://api.editgrid.com", "CellSetInputRequest"));
