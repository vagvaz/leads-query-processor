...
public class WorksheetUpdateRequest implements java.io.Serializable {
	/**
	 * 
	 */
	private static final long					serialVersionUID	= -6867749473440534935L;
	...
	public WorksheetUpdateRequest(java.lang.String sessionKey,
			java.lang.String worksheet, com.apatar.editgrid.ws.Worksheet body) {
	...
	/**
	 * Gets the sessionKey value for this WorksheetUpdateRequest.
	 * 
	 * @return sessionKey
	 */
	...
	/**
	 * Sets the sessionKey value for this WorksheetUpdateRequest.
	 * 
	 * @param sessionKey
	 */
	...
	/**
	 * Gets the worksheet value for this WorksheetUpdateRequest.
	 * 
	 * @return worksheet
	 */
	...
	/**
	 * Sets the worksheet value for this WorksheetUpdateRequest.
	 * 
	 * @param worksheet
	 */
	...
	/**
	 * Gets the body value for this WorksheetUpdateRequest.
	 * 
	 * @return body
	 */
	...
	/**
	 * Sets the body value for this WorksheetUpdateRequest.
	 * 
	 * @param body
	 */
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof WorksheetUpdateRequest)) {
			return false;
		}
		WorksheetUpdateRequest other = (WorksheetUpdateRequest) obj;
		if (obj == null) {
			return false;
		}
		if (this == obj) {
	...
	private static org.apache.axis.description.TypeDesc	typeDesc	= new org.apache.axis.description.TypeDesc(
																			WorksheetUpdateRequest.class,
																			true);

	static {
		typeDesc.setXmlType(new javax.xml.namespace.QName(
				"http://api.editgrid.com", "WorksheetUpdateRequest"));
