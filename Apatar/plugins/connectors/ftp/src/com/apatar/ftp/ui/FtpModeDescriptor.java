...
public class FtpModeDescriptor extends WizardPanelDescriptor {
	
	public static final String IDENTIFIER = "FTPMODE_PANEL";
	
	JFtpModePanel panel = new JFtpModePanel();
	Object backDescriptor;
	Object nextDescriptor;
	FtpNode node = null;
	
	public FtpModeDescriptor(FtpNode node, Object backDescriptor, Object nextDescriptor) {
		super();
