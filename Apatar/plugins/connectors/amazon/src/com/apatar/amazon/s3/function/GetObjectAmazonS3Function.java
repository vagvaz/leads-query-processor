...
public class GetObjectAmazonS3Function extends AmazonS3Function {

	public GetObjectAmazonS3Function(List<AmazonS3RequestParameters> request, List<AmazonS3RequestParameters> response, boolean workingWithBucket) {
		super("GetObject", "Read an object from S3", request, response, workingWithBucket);
	}
