...
public class JDB2PropertySheetPage extends JPropertySheetPage {
	...
	public JDB2PropertySheetPage(JDialog ownerDialog) {
		super(ownerDialog);
		owner = ownerDialog;
	}
	...
	protected void createComponent() {
		...
		JButton browseButton = new JButton("Manage Licenses");
		...
		browseButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				try {
					dlg = new JManageLicensesDialog(owner);
					dlg.setVisible(true);
