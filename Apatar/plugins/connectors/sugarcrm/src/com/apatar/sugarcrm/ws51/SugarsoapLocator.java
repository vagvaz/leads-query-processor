...
public class SugarsoapLocator extends org.apache.axis.client.Service implements com.apatar.sugarcrm.ws51.Sugarsoap {
    ...
    private java.lang.String sugarsoapPort_address = "http://sugar51.loc/soap.php";
    ...
    public com.apatar.sugarcrm.ws51.SugarsoapPortType getsugarsoapPort() throws javax.xml.rpc.ServiceException {
    ...
    public com.apatar.sugarcrm.ws51.SugarsoapPortType getsugarsoapPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.apatar.sugarcrm.ws51.SugarsoapBindingStub _stub = new com.apatar.sugarcrm.ws51.SugarsoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.apatar.sugarcrm.ws51.SugarsoapPortType.class.isAssignableFrom(serviceEndpointInterface)) {
                com.apatar.sugarcrm.ws51.SugarsoapBindingStub _stub = new com.apatar.sugarcrm.ws51.SugarsoapBindingStub(new java.net.URL(sugarsoapPort_address), this);
                _stub.setPortName(getsugarsoapPortWSDDServiceName());
                return _stub;
            }
        }
