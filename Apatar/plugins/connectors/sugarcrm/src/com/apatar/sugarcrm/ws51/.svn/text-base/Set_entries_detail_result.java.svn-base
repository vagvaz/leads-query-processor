...
public class Set_entries_detail_result  implements java.io.Serializable {
    private com.apatar.sugarcrm.ws51.Name_value[][] name_value_lists;
    ...
    public Set_entries_detail_result(
           com.apatar.sugarcrm.ws51.Name_value[][] name_value_lists,
     ...
     */
    public com.apatar.sugarcrm.ws51.Name_value[][] getName_value_lists() {
        return name_value_lists;
    }
     ...
     */
    public void setName_value_lists(com.apatar.sugarcrm.ws51.Name_value[][] name_value_lists) {
        this.name_value_lists = name_value_lists;
    }
