...
public class Get_relationships_result  implements java.io.Serializable {
    private com.apatar.sugarcrm.ws51.Id_mod[] ids;
    ...
    public Get_relationships_result(
           com.apatar.sugarcrm.ws51.Id_mod[] ids,
     ...
     * @return ids
     */
    public com.apatar.sugarcrm.ws51.Id_mod[] getIds() {
        return ids;
    }
     ...
     * @param ids
     */
    public void setIds(com.apatar.sugarcrm.ws51.Id_mod[] ids) {
        this.ids = ids;
    }
