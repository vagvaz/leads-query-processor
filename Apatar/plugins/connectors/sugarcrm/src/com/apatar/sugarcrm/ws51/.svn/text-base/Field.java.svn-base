...
public class Field  implements java.io.Serializable {
    ...
    private com.apatar.sugarcrm.ws51.Name_value[] options;
    ...
    public Field(
           ...
           int required,
           com.apatar.sugarcrm.ws51.Name_value[] options,
     ...
     * @return options
     */
    public com.apatar.sugarcrm.ws51.Name_value[] getOptions() {
        return options;
    }
     ...
     * @param options
     */
    public void setOptions(com.apatar.sugarcrm.ws51.Name_value[] options) {
        this.options = options;
    }
