...
public class DeathIndexCdyneNodeFactory extends NodeFactory {
	...
	public DeathIndexCdyneNodeFactory() {
		super();
		FunctionLoder.loadNodeFunction(
				"com.apatar.cdyne.function.DeathIndexCdyneFunction",
				functionNodeFactory);
	}
	...
	public AbstractNode createNode() {
		DeathIndexCdyneNode node = new DeathIndexCdyneNode();
		return node;
	}

	@Override
	public String getNodeClass() {
		return DeathIndexCdyneNode.class.getName();
	}
