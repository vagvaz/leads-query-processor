...
public class DSPM extends FIP {
    ...
    public void processEdge(Object U, Object V) {
        ...
        if (graphCache.get(U) != null) {
            ...
            if (!(((DSPMNode) graphCache.get(U)).getNeighbours()
                      .contains(V))) {//link-addition inside func
                updateWalks(U, V);
    ...
    private void mapUpdate(Object key, TObjectIntHashMap tempMap, DSPMNode tmpNode,
                              boolean negative) {
